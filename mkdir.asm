...
main(int argc, char *argv[])
{
  ...
  25:	e8 6e 02 00 00       	call   298 <mkdir>
  ...
  41:	c7 44 24 04 a1 06 00 	movl   $0x6a1,0x4(%esp)
  48:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 303:	f7 f6                	div    %esi
 305:	8a 92 c4 06 00 00    	mov    0x6c4(%edx),%dl
...
putc(int fd, char c)
{
 ...
 521:	e9 89 fe ff ff       	jmp    3af <printf+0x4b>
        ...
        if(s == 0)
          s = "(null)";
 526:	bf bd 06 00 00       	mov    $0x6bd,%edi
...
free(void *ap)
{
 ...
 53c:	a1 3c 09 00 00       	mov    0x93c,%eax
...
free(void *ap)
{
 ...
 577:	89 10                	mov    %edx,(%eax)
  freep = p;
 579:	a3 3c 09 00 00       	mov    %eax,0x93c
}
 57e:	5b                   	pop    %ebx
 57f:	5e                   	pop    %esi
 580:	5f                   	pop    %edi
 ...
 5a4:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 5a6:	a3 3c 09 00 00       	mov    %eax,0x93c
}
 5ab:	5b                   	pop    %ebx
 5ac:	5e                   	pop    %esi
 5ad:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5c2:	46                   	inc    %esi
  if((prevp = freep) == 0){
 5c3:	8b 1d 3c 09 00 00    	mov    0x93c,%ebx
 ...
 5ed:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 5ef:	3b 15 3c 09 00 00    	cmp    0x93c,%edx
...
morecore(uint nu)
{
 ...
 619:	e8 12 ff ff ff       	call   530 <free>
  return freep;
 61e:	8b 15 3c 09 00 00    	mov    0x93c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
...
morecore(uint nu)
{
 ...
 67d:	00 00 00 
 680:	ba 40 09 00 00       	mov    $0x940,%edx
